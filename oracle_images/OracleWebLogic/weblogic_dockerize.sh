...
cd /devops/docker/oracle_images/OracleWebLogic/dockerfiles/12.1.3/

#Copy/Download file fmw_12.1.3.0.0_wls.jar here

./buildDockerImage.sh -v 12.1.3 -g -c

#5. Extend the Oracle WebLogic image by creating a sample empty domain
cd /devops/docker/oracle_images/OracleWebLogic/samples/1213-domain/
./build.sh PassworD754
